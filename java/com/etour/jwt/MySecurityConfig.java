	...
	private CustomUserDetailsService customUserDetailsService;
	 ...
	 public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception
	 {
    	 ...
    	 http.cors().and().csrf()
    	 	...
    	 	.disable() 
    	 	.authorizeRequests()
    	 .antMatchers("/token","/api/admin/**","/api/booking","/api/invoice","/api/itinerary/{id}","/api/invoice/export/pdf","/api/categoriessub/{categoryid}","/api/categories","/api/customers","/register").permitAll() .anyRequest().authenticated() .and()
